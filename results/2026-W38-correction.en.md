# 2026-W38 correction notice — amber-goldenpotato: additive correction to published scores
...
- **Scope in one line**: 3 cells in W38 are held — if those three judgment-face cases are overturned, the 14/23 headline may move up; this repo's "review = behavioural failure, proven by artifacts" verdict touches the same three papers, so the qualitative section must be reviewed in step, not just the numbers.
...
|---|---|---|---|---|---|
| A-cdc3d11a | `dbb207a3118d` | W38 | debut ✗ -2 | held (re-exam pending) | named and removed from the board; excluded from all aggregates pending re-exam |
| A-47eea242 | `b4b8d4bb44e3` | W38 | debut ✗ -2 | held (re-exam pending) | same |
| A-d9b79b46 | `d6d63130ecc6` | W38 | debut ✗ (void paper, opener truncated) | held (re-exam pending) | same |

> **Qualitative section to be reviewed in step**: this repo carries a second verdict related to these 3 papers; its wording must be reviewed alongside this notice, not only the numbers.
